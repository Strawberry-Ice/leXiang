		...
		<div class="page">
			<div class="mt10 mb10">
				<form:form method="post" modelAttribute="httpActivity" action="${pageContext.request.contextPath }/weichatActivity/" cssClass="mt10 mb10 add-form" id="activityForm" cssStyle="padding-bottom: 40px;" enctype="multipart/form-data">
					<dl>
						<dt>商品名称：</dt>
						<dd class="text-left"><form:input path="name" placeholder="商品名称"/></dd>
						<dd class="error"><form:errors path="name"/></dd>
					</dl>
					<dl>
						<dt>商品状态：</dt>
						<dd style="border:0 none;">
							 <label for=""><form:radiobutton path="goodsStatus" value="SELLING"/>出售中</label>
        					<label for=""><form:radiobutton path="goodsStatus" value="SOLD"/>已出售</label>
						</dd>
					</dl>
					<dl>
						<dt>商品图片：</dt>
