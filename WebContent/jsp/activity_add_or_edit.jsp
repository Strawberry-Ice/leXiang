				...
				<div class="col-xs-12">
					...
					<form:form method="post" modelAttribute="httpActivity"
						...
						<sec:authorize
							...
							<c:choose>
								<c:when
									test="${httpActivity.id == ''|| httpActivity.id == null}">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-1"> 报名截止时间 </label>

							<div class="col-sm-9">
								<div class="clearfix">
									<div class="input-group col-xs-10 col-sm-5">
										<form:input path="applicationEndDates"
											cssClass="form-control date-picker" id="id-date-picker-1"
											data-date-format="yyyy-mm-dd" />
										<span class="input-group-addon"> <i
											class="fa fa-calendar bigger-110"></i>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-1"> 活动开始时间 </label>

							<div class="col-sm-9">
								<div class="clearfix">
									<div class="input-group col-xs-10 col-sm-5">
										<form:input path="activtyStartDates"
											cssClass="form-control date-picker" id="id-date-picker-1"
											data-date-format="yyyy-mm-dd" />
										<span class="input-group-addon"> <i
											class="fa fa-calendar bigger-110"></i>
								...
								<div style="color: red;" class="help-block">
									<form:errors path="activtyStartDates" />
								</div>
							</div>
						</div>
						...
						<!-- <div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-1"> 活动截止时间 </label>

							<div class="col-sm-9">
								<div class="clearfix">
									<div class="input-group col-xs-10 col-sm-5">
										<form:input path="activityEndDates"
											cssClass="form-control date-picker" id="id-date-picker-1"
											data-date-format="yyyy-mm-dd" />
										<span class="input-group-addon"> <i
											class="fa fa-calendar bigger-110"></i>
								...
								<div style="color: red;" class="help-block">
									<form:errors path="activityEndDates" />
								</div>
							</div>
						</div>-->
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-5">报名审核</label>

							<div class="col-xs-3">
								<label> <fytec:checkbox path="needVerify"
										cssClass="ace ace-switch ace-switch-5" /> <span class="lbl"></span>
								</label>
							</div>
						</div>
								...
								<div class="col-xs-12 col-sm-5">
									<div class="clearfix">
										<div class="control-group">
											<div class="checkbox">
												<c:forEach var="fieldsType"
													items="${httpActivity.fieldsType}">

													<label> <fytec:checkbox
															cssClass="ace ace-checkbox-2" path="filedType"
															value="${fieldsType.id }" /><span class="lbl">${fieldsType.name }</span>
													</label>
												</c:forEach>
											</div>
										</div>
