				...
				<div class="col-xs-12">
					...
					<form:form commandName="user" action="${pageContext.request.contextPath }/user/update" class="form-horizontal" method="post" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<form:input path="nickName" id="form-field-1" readonly="true" placeholder="昵称"
...
<sec:authorize access="hasRole('ROLE_Role_sys_admin')">  
							...
							<div class="row">
								<div class="col-xs-12 col-sm-5">
									<div class="control-group">
										<div class="radio">
										<fytec:radiobuttons disabled="true" path="role.id" items="${roles }" itemLabel="name" itemValue="id"/>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="form-group" id="parentGovOrgDiv" style="display: none">
							...
							<div class="col-sm-9">
								<form:select class="form-control" disabled="true" cssStyle="width:auto" path="parentGovOrg" id="parentGovOrg">
						...
						<div class="form-group" id="childGovOrgDiv" style="display: none">
							...
							<div class="col-sm-9">
								<select class="form-control" disabled="disabled" style="width:auto" name="govOrg.id" id="childGovOrg">
						...
						<div class="form-group" id="orgDiv" style="display: none">
							...
							<div class="col-sm-9">
								<form:select class="form-control" disabled="true" cssStyle="width:auto" path="org.id" id="org.id">
									<form:option value="">请选择</form:option>
...
<form:hidden path="org.id"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<form:textarea path="description" readonly="true" class="col-xs-10 col-sm-5"/>
								<span class="help-inline col-xs-12 col-sm-7">
