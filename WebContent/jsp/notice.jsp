			...
			jQuery(function($) {
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					colNames:[ '编号','公告名称','发布时间','状态','街道或社工委','社区'],
					colModel:[
						
						{name:'seq',index:'seq', width:60, editable: true,search:false},
						{name:'name',index:'name',width:90, editable:true, editoptions:{size:"20",maxlength:"30"}},
						{name:'createDates',index:'createDate', width:150,editable: true,sorttype:"date",search:false},
			        ...
			        gridComplete: function (){
			            ...
			            for (var i = 0; i < ids.length; i++) { 
							...
							//jQuery(grid_selector).jqGrid('setRowData', ids[i], {name: "<a href='addoreditnotice.html?id="+ids[i]+"'>"+rowdata.name+"</a>"}); 
