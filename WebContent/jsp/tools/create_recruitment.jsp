	...
	<div class="main-content-inner">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form:form method="post" modelAttribute="httpActivity" action="${pageContext.request.contextPath }/tools/" cssClass="form-horizontal" id="activityForm">
						<!-- #section:elements.form -->
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 招募名称 </label>
							<div class="col-sm-9">
								<div class="clearfix">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								...
								<c:if test="${!empty httpActivity.id}">
									<form:input path="quota" readonly="true" cssClass="col-xs-1" placeholder="0"/>
								</c:if>
