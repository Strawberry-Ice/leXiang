			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form:form class="form-horizontal" commandName="scoreShopItem"
						role="form" action="${pageContext.request.contextPath }/score/shop/add">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 礼品来源 </label>
							<div class="col-sm-9">
								<form:select class="form-control" cssStyle="width:auto" path="org.id" id="parentGovOrg">
							...
							<div class="col-sm-9">
								<div class="col-xs-12 col-sm-4">
									<span class="profile-picture"> <img id="avatar"
										...
										src="${pageContext.request.contextPath }${scoreShopItem.logo}" onerror="javascript:this.src='${pageContext.request.contextPath }/assets/images/no-pic.jpg';"/>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<form:input path="price" class="col-xs-1"
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 下架时间 </label>

							<div class="col-sm-9">
								<div class="clearfix">
									<div class="input-group col-xs-10 col-sm-5">
										<form:input path="expiry" cssClass="form-control date-picker" id="id-date-picker-1" data-date-format="yyyy-mm-dd"/>
								...
								<div style="color: red;" class="help-block" ><form:errors path="expiry"/></div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<form:input path="num" class="col-xs-1" id="form-field-5"
										placeholder="0" />
										 <span
									class="middle"><font color="red"><form:errors
												path="num" /></font></span>
								...
								<div class="col-xs-12 col-sm-5">
									<div class="control-group">
										<div class="radio">
											...
											<label> <form:radiobutton path="type.id" class="ace"
													value="-1" /> <span class="lbl">&nbsp;&nbsp;其他类</span>
											</label>
										</div>
									</div>
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<form:input path="type.ratio" class="col-xs-1"
										id="form-field-5" placeholder="0" readonly="true"/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<form:input path="score" readonly="true" id="form-field-1" placeholder="所需积分"
									class="col-xs-1" />
							</div>
						</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp; <a class="btn btn-danger"
									href="${pageContext.request.contextPath }/score/shop/list"> <i
...
<script type="text/javascript">
	...
	jQuery(function($) {
		...
		$("input[name='type.id']").each(function(i) {
			$(this).click(function() {
				if ($(this).val() == -1) {
					$("input[name='type.ratio']").removeAttr("disabled");
					$("input[name='type.ratio']").attr("readOnly",false);
					$("input[name='type.ratio']").val(0);
					$("input[name='score']").removeAttr("disabled");
					$("input[name='score']").val(0);
				} else {
					$.get("${pageContext.request.contextPath}/score/shop/getRatio", { id: $(this).val(), time: new Date().getTime() }, function(data){
						if(data==-1){
							$("input[name='type.ratio']").attr("disabled",true);
							$("input[name='type.ratio']").val(0);
							$("input[name='score']").attr("disabled",true);
							$("input[name='score']").val(0);
						}else{
							$("input[name='type.ratio']").removeAttr("disabled");
							$("input[name='type.ratio']").attr("readOnly",true);
							$("input[name='type.ratio']").val(data);
							$("input[name='score']").removeAttr("disabled");
							initScore();
						}
					});
	...
	function toVaild(){
		...
		$("#status").val(true);
		if($("input[name='type.id']:checked").val()!= undefined){
