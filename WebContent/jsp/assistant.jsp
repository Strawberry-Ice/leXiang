	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>
					二手管理 <small> <i class="ace-icon fa fa-angle-double-right"></i>
					</small>
...
<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colNames:[ '序号','商品名称','状态','是否允许推荐','街道或社工委','社区'],
					colModel:[
						...
						{name:'goodsStatus',index:'goodsStatus', width:90, sortable:false,editable: true,editoptions:{size:"20",maxlength:"30"}},
				...
				jQuery(grid_selector).jqGrid('navGrid',pager_selector,
					...
					{
						//view record form
						url: '${pageContext.request.contextPath }/activity/view/${code}', 
						recreateForm: true,
						beforeShowForm: function(e){
							var form = $(e[0]);
							form.closest('.ui-jqdialog').find('.ui-jqdialog-title').wrap('<div class="widget-header" />')
