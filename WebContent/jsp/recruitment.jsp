	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>
					招募 <small> <i class="ace-icon fa fa-angle-double-right"></i>
						招募管理
					</small>
...
<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colNames:[ '序号','招募名称', '已报名人数','活动名额','报名开始时间','报名截止时间', '状态','是否允许推荐','街道或社工委','社区'],
					colModel:[
						...
						{name:'applicationStartDates',index:'applicationStartDates', width:150,search:false},
