				...
				<div class="col-xs-12">
					...
					<form:form class="form-horizontal" commandName="scoreShopItem"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<form:input path="name" id="form-field-1" readonly="true"
									placeholder="礼品名称" class="col-xs-10 col-sm-5" />
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<form:select class="form-control" disabled="true"
									cssStyle="width:auto" path="org.id" id="parentGovOrg">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="col-xs-12 col-sm-4">
									<span class="profile-picture"> <img id="avatar2"
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<div class="input-group col-xs-10 col-sm-5">
										<form:input path="expiry" readonly="true"
											cssClass="form-control" data-date-format="yyyy-mm-dd" />
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<form:input path="day" readonly="true" class="col-xs-1" id="form-field-5"
										placeholder="0" />
									<span class="middle"><font color="red"><form:errors
												path="day" /></font></span>
								</div>
							...
							<div class="row">
								<div class="col-xs-12 col-sm-5">
									<div class="control-group">
										<div class="radio">
											<fytec:radiobuttons disabled="true" path="type.id"
												items="${shopItemTypes }" itemLabel="name" itemValue="id" />
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="clearfix">
									<form:input readonly="true" path="type.ratio" class="col-xs-1"
										id="form-field-5" placeholder="0" />
								</div>
							</div>
						</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								<a class="btn btn-danger"
									...
									<i class="ace-icon fa fa-remove bigger-110"></i> 返回列表页面
								</a>
							</div>
						</div>
