...
<body>
			...
			<div class="mt10 mb10">
				<form:form method="post" modelAttribute="httpActivity"
						...
						<dd>
							<p id="thumbs" class="thumbs">
								<c:if test="${not empty httpActivity.imgUrl}">
									<img id="my_img" width="334px" height="324px" src="<fytec:image url="${httpActivity.imgUrl }" size="242_253"/>" alt="">
								</c:if>
							</p>
					...
					<dl>
						...
						<dd class="error"><form:errors path="filedType"/></dd>
					</dl>
					<dl>
						<dt>活动内容：</dt>
						<dd>
						...
						<dd class="error"><form:errors path="content"/></dd>
					</dl>
					<dl>
						<dt></dt>
						<dd>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#applicationStartDates").mobiscroll(
					$.extend(opt['date'], opt['test']));
			$("#applicationEndDates").mobiscroll(
					$.extend(opt['date'], opt['test']));
