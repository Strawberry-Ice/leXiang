		...
		<div class="page">
			...
			<form:form method="post" modelAttribute="httpActivity"
				...
				<dl>
					<dt>商品名称：</dt>
					<dd class="text-left">
						<form:input path="name" placeholder="商品名称" />
					</dd>
					<dd class="error">
				...
				<dl>
					...
					<dd style="border: 0 none; padding-top: 6px;">
						<label for=""><form:radiobutton path="goodsStatus"
								value="SELLING" />出售中</label> <label for=""><form:radiobutton
								path="goodsStatus" value="SOLD" />已出售</label>
					</dd>
					<dd class="error">
						<form:errors path="goodsStatus" />
					</dd>
				</dl>
				<dl>
					<dt>商品图片：</dt>
