										...
										<sec:authorize access="hasRole('ROLE_Role_sys_admin')">
											<div class="form-group">
												<c:if test="${httpActivity.occasion=='2'}">
											  			<div class="form-group">
																<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 发布场合 </label>
																<div class="col-sm-9">
																	 <label class="col-xs-10 col-sm-5" style="margin-top: 6px;">广场</label>
																</div>
													</div>
											  </c:if>
										...
										<c:choose>
										    <c:when test="${httpActivity.id == ''|| httpActivity.id == null}">
													...
													<div class="form-group" id="community">
														...
														<div class="col-sm-9">
															<div class="clearfix">
																<select name="govOrgIds" class="col-xs-10 col-sm-5" id="form-field-select-2" multiple="multiple">
																</select>
																<label><b style="color:red;">*</b> 按住Ctrl可多选 </label>
															</div>
							...
							<div class="col-sm-9">
								...
								<div style="color: red;" class="help-block">
									...
									<div class="form-group" id="noticeContent">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-5">公告内容</label>
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											&nbsp; &nbsp; &nbsp;
											<a class="btn btn-danger" href="${pageContext.request.contextPath }/activity/notice/${code }">
