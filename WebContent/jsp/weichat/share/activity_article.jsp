		   ...
		   <div id="mcover" onclick="weChat()" style="display:none;">
			...
			<div id="content" class="mt10 mb10">
				<div class="activity-content">
					<div class="title">
						<span class="fr gray" style="display: none;">
					...
					<div class="text-center share" style="padding-bottom: 50px;display: none;">
						<a href="javascript:;" id="onMenuShareAppMessage" class="bg-orange">
							<i class="icon-forward">发送给朋友</i>
						</a>
						<a href="javascript:;" id="onMenuShareTimeline" class="bg-orange" style="margin-left: 25px;">
